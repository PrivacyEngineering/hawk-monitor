import { Box, Button, Flex, Grid, Select, Table, Tbody, Td, Text, Th, Thead, Tr, useColorModeValue, VStack } from "@chakra-ui/react";
      ...
      <Card>
        ...
        <Flex direction={"column"} width={"100%"}>
          <Grid templateColumns='repeat(12, 1fr)' gap={4}>
            <Box gridColumn={{ base: "span 12", sm: "span 6", md: "span 4" }}>
